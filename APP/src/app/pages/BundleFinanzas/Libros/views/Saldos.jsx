...
import Saldo from '../includes/Saldo'
import Loading from '@components/Navigators/Loading'
import { saldosData, resetItems } from '@reducers/contabilidad/contabilidadSlice'
          ...
          <div className='mt-1 flex-col p-2'>          
              <div className="flex-col flex">            
                  ...
                  <div className="flex-col rounded p-1 flex">   
                      <label htmlFor="hasta" className="h-6 pl-1 font-bold text-gray-500 text-[10px]">Ejercicio en Fecha</label>         
                      <DatePicker 
